...
const audience = [
    "Quer economizar com manutenção preventiva e evitar gastos desnecessários na oficina.",
    "Deseja viajar com mais segurança, sabendo identificar e resolver pequenos problemas na estrada.",
    "Quer entender a ergonomia da sua moto para pilotar com mais conforto e menos fadiga.",
    "É iniciante e busca um conhecimento prático e direto ao ponto sobre sua Big Trail."
];

const learningOutcomes = [
    "Realizar diagnósticos básicos e preventivos na sua moto.",
    "Ajustar a ergonomia (guidão, manetes, pedais) para o seu biotipo.",
    "Entender o funcionamento dos principais sistemas da sua motocicleta."
];

const faqs = [
    {
        q: "Para quem é este curso?",
        a: "Para proprietários de Big Trails (especialmente BMW GS) que querem autonomia básica, segurança mecânica e conforto ergonômico."
    },
    {
        q: "Preciso ter ferramentas profissionais?",
        a: "Não. O curso ensina você a montar um kit básico e eficiente para ter em casa ou levar na viagem."
    },
    {
        q: "O acesso é vitalício?",
        a: "Sim! Você paga uma única vez e acessa o conteúdo para sempre, com direito a todas as atualizações futuras."
    },
    {
        q: "Serve para qual modelo de moto?",
        a: "O foco principal é na linha BMW GS (1200/1250), mas os conceitos de ergonomia e mecânica básica se aplicam a quase todas as Big Trails."
    },
    {
        q: "Tem certificado?",
        a: "Com certeza. Ao concluir o curso, você emite seu certificado oficial Pro Riders diretamente na plataforma."
    }
];
        ...
        <div className="bg-[#050505] min-h-screen text-gray-100 font-sans selection:bg-brand-red selection:text-white overflow-x-hidden">
            ...
            <section className="relative min-h-screen flex items-center justify-center overflow-hidden py-20">
                ...
                <div className="container mx-auto px-4 relative z-10 flex flex-col md:flex-row items-center">
                    ...
                    >
                        <span className="inline-block px-4 py-2 rounded-full bg-brand-red/10 text-brand-red font-semibold mb-6 border border-brand-red/20">
                            Curso Online com Fernando Macedo
                        </span>

                        <h1 className="text-4xl md:text-6xl font-extrabold text-white leading-[1.1] mb-6 tracking-tight">
                            Curso de Mecânica <br />
                            <span className="text-brand-red">Básica e Ergonomia</span>
                        </h1>

                        <p className="text-lg md:text-2xl text-gray-300 mb-8 leading-relaxed font-light max-w-2xl border-l-4 border-brand-red pl-6">
                            Domine os ajustes essenciais da sua Big Trail e viaje com mais segurança e conforto.
                        </p>

                        <div className="flex flex-col gap-3 mb-10 text-gray-400">
                            {[
                                "Autonomia para cuidar da sua GS.",
                                "Conhecimento técnico direto ao ponto.",
                                "Ajustes ergonômicos para viagens longas."
                            ].map((item, i) => (
                ...
                <div className="container mx-auto px-4 relative z-10 text-center mb-10">
                    ...
                    <div className="max-w-4xl mx-auto aspect-video rounded-2xl overflow-hidden shadow-[0_0_40px_rgba(217,35,35,0.2)] border border-white/10">
                        <iframe
                            width="100%"
                            height="100%"
                            src="https://www.youtube.com/embed/D-2GeOqUoHg"
                            title="Apresentação do curso Mecânica Básica BMW"
                            frameBorder="0"
                ...
                <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-16 items-center">
                    <motion.div {...fadeUp}>
                        ...
                        <p className="text-gray-400 text-lg mb-8 leading-relaxed">
                            O Curso de Mecânica Básica e Ergonomia foi pensado para quem quer ter mais intimidade com a sua Big Trail.
                        </p>
            ...
            {/* 4. INSIDE THE COURSE (MODULES/BONUS) */}
                ...
                <div className="container mx-auto px-4 max-w-5xl relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-400 text-xl max-w-3xl mx-auto">
                            Um pacote completo para você dominar sua moto.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
                        {[
                            {
                                icon: Brain,
                                title: "Metodologia Pro Riders",
                                text: "Aprenda com o método validado em centenas de motos na oficina.",
                                originalValue: "197,00",
                            },
                            {
                                icon: Wrench,
                                title: "Ajustes Práticos",
                                text: "Ergonomia, suspensão e comandos personalizados para você.",
                                originalValue: "147,00",
                            },
                            {
                                icon: ShieldCheck,
                                title: "Segurança de Voo",
                                text: "Checklists pré-viagem para rodar tranquilo.",
                                originalValue: "147,00",
                            },
                            {
                                icon: Award,
                                title: "Certificado de Conclusão",
                                text: "Comprove seu conhecimento com o certificado Pro Riders.",
                                originalValue: "97,00",
                            },
                            {
                                icon: Activity,
                                title: "Acesso Vitalício",
                                text: "O curso é seu para sempre. Revise quando quiser.",
                                originalValue: "197,00",
                            },
                            {
                                icon: Star,
                                title: "VALOR TOTAL",
                                text: "Todo esse conhecimento reunido por um preço simbólico.",
                                originalValue: "785,00",
                                isTotal: true
                            }
                        ].map((bonus, index) => (
                    ...
                    <div className="text-center">
                        <a href="#offer">
                            <ShinyButton className="w-full md:w-auto justify-center px-12 py-5 text-xl">Quero começar agora</ShinyButton>
                        </a>
                    </div>
                </div>
            </section>
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-4xl mx-auto bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl shadow-[0_0_80px_rgba(217,35,35,0.15)] p-1 md:p-1 relative overflow-hidden">
                        ...
                        <div className="bg-[#0a0a0a]/90 rounded-[22px] p-8 md:p-12 text-center">
                            <span className="text-[#D4AF37] font-bold tracking-[0.2em] uppercase text-xs block mb-4">Oportunidade Única</span>
                            ...
                            <div className="flex flex-col items-center justify-center mb-8">
                                <p className="text-gray-400 text-sm font-medium uppercase tracking-wider mb-2">De R$ 197,00 por</p>
                            ...
                            <p className="text-gray-400 mb-10 text-lg max-w-xl mx-auto">
                                Aprenda a cuidar da sua moto com segurança e evite gastos desnecessários na oficina.
                            </p>

                            <div className="grid sm:grid-cols-2 gap-4 max-w-2xl mx-auto mb-10 text-left">
                                <ul className="space-y-3">
                                    <li className="flex gap-2 text-gray-300 text-sm"><CheckCircle2 className="text-brand-red w-5 h-5" /> Acesso Vitalício</li>
                                    <li className="flex gap-2 text-gray-300 text-sm"><CheckCircle2 className="text-brand-red w-5 h-5" /> Certificado Pro Riders</li>
                                </ul>
                                <ul className="space-y-3">
                                    <li className="flex gap-2 text-gray-300 text-sm"><CheckCircle2 className="text-brand-red w-5 h-5" /> Didática Simples e Direta</li>
                                    <li className="flex gap-2 text-gray-300 text-sm"><CheckCircle2 className="text-brand-red w-5 h-5" /> Suporte a Dúvidas</li>
                                </ul>
                            </div>

                            <a href="https://pay.kiwify.com.br/s2y3F0t" target="_blank" rel="noopener noreferrer">
            ...
            <section className="py-24 bg-[#050505] text-center border-t border-gray-900">
                <div className="container mx-auto px-4">
                    ...
                    <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 tracking-tight">Comece sua jornada mecânica hoje mesmo</h2>
                    <p className="text-gray-400 text-lg mb-10 max-w-2xl mx-auto">
                        Acesso imediato, certificado incluso e garantia de 7 dias.
                    </p>
...
export default BasicMechanicsLP;
